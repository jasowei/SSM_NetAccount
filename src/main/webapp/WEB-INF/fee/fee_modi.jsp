...
<!--主要区域开始-->
<div id="main">
    <div id="save_result_info" class="save_fail">修改失败！资费名称已存在!</div>
    <form id="edit" action="/cost/updateCost" method="post" class="main_form">
        <div class="text_info clearfix"><span>资费ID：</span></div>
        <div class="input_info">
            <input id="costid" type="text" name="cost_id" class="readonly" readonly value="${cost.cost_id}"/></div>
